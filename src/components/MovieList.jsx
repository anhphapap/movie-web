...
const tops = [
  '<svg width="100%" height="100%" viewBox="-20 0 70 154" ><path stroke="#595959" stroke-linejoin="square" stroke-width="4" d="M35.377 152H72V2.538L2 19.362v30.341l33.377-8.459V152z"></path></svg>',
...
const CustomRightArrow = ({ onClick }) => {
  return (
    <button
      onClick={onClick}
      className="absolute right-0 top-0 h-full w-[4%] bg-black bg-opacity-30 p-3 text-white hover:bg-opacity-60 z-10 text-transparent hover:text-white transition-all ease-linear duration-100"
    >
      <FontAwesomeIcon icon="fa-solid fa-chevron-right" className="text-3xl" />
    </button>
  );
};
...
const CustomLeftArrow = ({ onClick }) => {
  return (
    <button
      onClick={onClick}
      className="absolute left-0 top-0 h-full w-[4%] bg-black bg-opacity-30 p-3 text-white hover:bg-opacity-60 z-10 text-transparent hover:text-white transition-all ease-linear duration-100"
    >
      <FontAwesomeIcon icon="fa-solid fa-chevron-left" className="text-3xl" />
    </button>
  );
};
...
const MovieList = ({ data, nameList, openModal, type }) => {
  if (!data[0]?.name) {
    return (
    ...
    if (type === "top") {
      return (
        <div className="pl-[3%] my-8 relative">
          <h2 className="text-white font-bold mb-3">{nameList}</h2>
          <Carousel
    ...
    return (
      <div className="pl-[3%] my-8 relative">
        ...
        >
          {data.map((item) => (
            <div
              className="aspect-video bg-cover rounded-md mr-2 group cursor-pointer"
              style={{
